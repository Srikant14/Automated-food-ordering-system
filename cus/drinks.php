<?php   
 ...
 <html>  
      ...
      <body>  
           ...
           <a href="menu.php" style="float: left">back</a>
           <a href="orderlist.php">view order</a> 
                <h3 align="center">DRINKS</h3><br />  
                <?php  
                $query = "SELECT * FROM drinks ORDER BY itemno ASC";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="drinks.php?action=add&id=<?php echo $row["itemno"]; ?>">  
