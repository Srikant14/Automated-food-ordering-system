...
function login($con) {
                  ...
                  $count=0;
                  $query = mysqli_query($con,"SELECT fullname,password FROM users WHERE fullname = '$email' AND password = '$password' ") or die(mysql_error()); 
                  $count=mysqli_num_rows($query);
 
                   // <a href='menu.php?var=email'>Data link</a>
         if($count){
                    ...
                    /*  echo "<script type='text/javascript'>\n";
                             echo "alert('UserName  Password...');\n";
                             echo "</script>";*/
         
                     header("Location: http://localhost/cus/menu.php");
        ...
        <input type="text" name="user" placeholder="Username" required="required" class="input-txt" />
          ...
          <div class="login-footer">
             <a href="#" class="lnk">
              ...
              <a href="signup.php" button type="submit" class="btn btn--right">SIGN UP </button></a>
              <a href="menu dev/index.html"></a><button type="submit" class="btn btn--down" name="login">LOG IN</button>
          </div>
      </form>
  </div>
</div>
